    ...
    <>
      ...
      <mobile className="md:hidden">
        ...
        <main className="flex flex-col items-center">
          <div className="bg-agent-gray relative flex w-screen h-[50vh]">
            ...
            <div className="z-20 flex flex-col gap-y-16 mt-16 pl-8">
              <div className="flex flex-col">
                <h3 className="text-white text-3xl w-full font-bold tracking-widest overflow-y-hidden">
                  KURUMSAL
                </h3>
                <h5 className="text-agent-purple font-semibold overflow-y-hidden text-3xl">
                  baskı hizmetlerinde
                </h5>
                <h3 className="text-white text-3xl w-full font-bold tracking-widest overflow-y-hidden">
                  ÇÖZÜM ORTAĞI
          ...
          <div>
            <NextLink href="/kimiz">
              <button className="bg-agent-purple text-white font-medium text-xl tracking-wide p-2 px-5 rounded-full mt-10">
                TANIŞALIM
              </button>
            </NextLink>
          </div>
